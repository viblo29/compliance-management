...
import Hover from "../molecules/Hover/Hover";
    ...
    <div>
      ...
      >
        <div className="w-[479.33] p-4 flex flex-col">
          ...
          />
          <div
            className="h-100.5 flex flex-col relative items-center justify-start p-6"
            style={{
          ...
          >
            <div
              ...
              style={{
                borderRadius:
                  "var(--Corner-radius-8px, 8px) var(--Corner-radius-8px, 8px) 0 0",
            ...
            <div
              ...
              style={{
                borderRadius:
                  "0 0 var(--Corner-radius-8px, 8px) var(--Corner-radius-8px, 8px)",
                border: "1px solid var(--Stroke-Solid, #38363E)",
              }}
            >
              <Risks
        ...
        <div className="w-[479.33] p-4 flex flex-col">
          <Title
            number={5}
            h1="Control Visibility"
            h2="Automatically determine which controls apply to each system based on its attributes."
          />
            <div className="h-100.5 flex relative items-center justify-center p-6" style={{
                  borderRadius: 'var(--Corner-radius-10px, 10px)',
                  border: '1px var(--Stroke-Gradient-2, #FFF)',
        ...
        <div className="w-[479.33] p-4 flex flex-col">
          <Title
            number={6}
            h1="System Inventory"
            h2="Maintain a structured record of applications, infrastructure, and assets across environments."
          />
